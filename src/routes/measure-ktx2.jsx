...
import { getBufferCopy, round2 } from '../utils'

export default function TranscodingBenchmark() {
                  ...
                  {computedStats.computed ? (
                    isSynchronous ? (
                      <Alert variant="info">
                        ...
                        <ListGroup>
                          <ListGroup.Item
                            variant={computedStats.transcodingTime < computedStats.playTime ? 'info' : 'danger'}
                          >
                      ...
                      <Alert variant="info">
                        ...
                        <ListGroup>
                          <ListGroup.Item
                            variant={
                              computedStats.totalTranscodingTime < computedStats.totalPlayTime ? 'info' : 'danger'
                            }
                          >
